...
plot(TwoDaydata$DateTime, TwoDaydata$Voltage, type="l", xlab="", ylab="Voltage")
...
plot(TwoDaydata$DateTime, TwoDaydata$Global_reactive_power, type="l", xlab="", ylab="Global_reactive_power")
dev.off()
